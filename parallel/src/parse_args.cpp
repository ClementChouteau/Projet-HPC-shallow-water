...
void parse_args(int argc, char** argv)
{
	...
	desc.add_options()("help,h", "Display this message")(
		"size_x,x", po::value< int >()->default_value(256),
		"Size of the first dimension of the domain")(
		"size_y,y", po::value< int >()->default_value(256),
		"Size of the second dimension of the domain")(
		"nb_steps,t", po::value< int >()->default_value(1000),
		"Number of time steps")("dt", po::value< double >()->default_value(300),
								"dt")(
		"dx", po::value< double >()->default_value(1000),
		"dx")("dy", po::value< double >()->default_value(1000), "dy")(
		"pcor", po::value< double >()->default_value(1.e-5),
		"pcor")("grav", po::value< double >()->default_value(0.01), "grav")(
		"dissip", po::value< double >()->default_value(0.00001),
		"dissip")("alpha", po::value< double >()->default_value(0.15), "alpha")(
